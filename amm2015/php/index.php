    ...
    public static function dispatch(&$request) {
        ...
        if (isset($request["page"])) {
            ...
            switch ($request["page"]) {
                ...
                // utente
                case 'utente':
                    // la pagina degli utenti e' accessibile solo
                    // agli utenti ed agli amminstratori
                ...
                // organizzatore
                case 'organizzatore':
                    // la pagina degli organizzatori e' accessibile solo
                    // agli organizzatori ed agli amminstratori
                    // il controllo viene fatto dal controller apposito
                    $controller = new OrganizzatoreController();
                    if (isset($_SESSION[BaseController::role]) &&
                        $_SESSION[BaseController::role] != User::Organizzatore)  {
                        self::write403();
                    }
                    $controller->handleInput($request);
                    break;
