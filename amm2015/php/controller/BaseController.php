...
class BaseController {
        ...
        if (isset($request["cmd"])) {
            ...
            switch ($request["cmd"]) {
                case 'login':
                    ...
                    if ($this->loggedIn())
                        $user = UserFactory::instance()->cercaUSerPerId($_SESSION[self::user], $_SESSION[self::role]);
                    break;
    ...
    protected function showHomeOrganizzatore($vd) {
        // mostro la home degli organizzatori
        $vd->setTitolo("SurfTrip - Organizzatore ");
        $vd->setMenuFile(basename(__DIR__) . '/../view/organizzatore/menu.php');
        $vd->setLogoFile(basename(__DIR__) . '/../view/organizzatore/logo.php');
        $vd->setLeftBarFile(basename(__DIR__) . '/../view/organizzatore/leftBar.php');
    ...
    /**
     * Aggiorno l'indirizzo di un utente (comune a Utente e Organizzatore)
    ...
    /**
     * Aggiorno l'indirizzo email di un utente (comune a Utente e Organizzatore)
     * @param User $user l'utente da aggiornare
     * @param array $request la richiesta http da gestire
     * @param array $msg riferimento ad un array da riempire con eventuali
     * messaggi d'errore
    ...
    /**
     * Aggiorno la password di un utente (comune a Utente e Organizzatore)
     * @param User $user l'utente da aggiornare
     * @param array $request la richiesta http da gestire
     * @param array $msg riferimento ad un array da riempire con eventuali
     * messaggi d'errore
